...
import wletter from "../assets/logo_w.svg";
...
const Page1 = () => {
  return (
    <div
      id="page1"
      className="flex-none w-screen h-screen md:w-[110vw] lg:w-[120vw] relative overflow-hidden"
    >
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-2 sm:space-y-3 md:space-y-4 order-2 lg:order-1 text-center lg:text-left">
                ...
                <h6 className="blend text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mt-2 sm:mt-3 md:mt-4 opacity-0 bg-abusinees transform -translate-x-full animate-slide-in">
              ...
              <div className="flex flex-col items-center space-y-4 sm:space-y-6 md:space-y-8 order-1 lg:order-2">
                ...
                <div className="flex items-center justify-center opacity-0 transform translate-y-full animate-slide-up-4">
                  ...
                  <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 flex items-center justify-center -ml-2 sm:-ml-3 md:-ml-4">
                    <img
                      src={dletter}
                      alt="D"
                      className="w-full h-full object-contain"
                ...
                <h5 className="bg-businees blend text-center text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg opacity-0 transform translate-y-full animate-slide-up-5">
